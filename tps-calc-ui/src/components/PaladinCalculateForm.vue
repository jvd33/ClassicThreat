<template>
  <q-page class="q-pa-md row-12" style="position: relative;" >
    ...
    <threat-result class="q-mt-sm q-mb-sm" v-if="this.results" :results="this.results" player_class="Paladin" />
    <q-expansion-item
...
export default {
  ...
  meta() {
    return {
      ...
      meta: {
        description: {name: 'description', content: 'Classic World of Warcraft Paladin Threat Calculator'},
      },
    }
  },
};
